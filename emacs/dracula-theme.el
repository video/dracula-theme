...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; `(mode-line ((,class (:foreground nil :background ,comment :box ,comment))))
   ...
   `(linum ((,class (:slant italic :foreground ,fg4 :background ,bg3))))
   `(header-line ((,class (:weight bold :underline ,bg1 :overline ,bg1 :foreground ,bg1 :background ,rainbow-7))))
   ...
   `(ido-subdir ((,class (:foreground ,func))))
   ...
   `(helm-source-header ((,class (:family "Sans Serif" :height 1.3 :weight bold :foreground nil :background ,comment))))
   `(helm-selection ((,class (:inherit hl-line))))
   `(helm-selection-line ((,class (:background ,bg2))))
   `(helm-visible-mark ((,class (:inherit region))))
   `(helm-candidate-number ((,class (:foreground ,bg1 :background ,rainbow-7))))
